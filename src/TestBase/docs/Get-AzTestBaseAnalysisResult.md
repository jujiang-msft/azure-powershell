...
online version: https://docs.microsoft.com/powershell/module/az.testbase/get-aztestbaseanalysisresult
schema: 2.0.0
---

# Get-AzTestBaseAnalysisResult
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.TestBase.Support.AnalysisResultType
Parameter Sets: List
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.TestBase.Support.AnalysisResultName
Parameter Sets: Get
Aliases: AnalysisResultName
